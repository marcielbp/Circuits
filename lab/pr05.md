...
Implemente um circuito somador de duas entradas de 4 bits A3A2A1A0 e B3B2B1B0 cuja saída seja uma palavra binária Σ3Σ2Σ1Σ0 e um bit de *carry out* C1. A entrada de carry in C0 deve receber valor 0. Represente a saída binária nos leds do kit utilizando a sequência de exibição horizontal C1Σ3Σ2Σ1Σ0. Escolha 16 pares de valores em 4 bits para as variáveis A e B e apresente uma tabela com a saída do somador.
