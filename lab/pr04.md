...
1. Implemente no Simulador um circuito que visualize todas as combinações BCD utilizando o circuito [7447](http://www.farnell.com/datasheets/59373.pdf) (decodificador BCD - 7 segmentos). Verifique todas as saı́das para todas as entradas possı́veis. Verifique também as entradas não válidas no código BCD.

![](./pr04/media/aaa.png)

2. Implemente um circuito utilizando qualquer conjunto de portas lógicas que seja capaz de, a partir de uma entrada de 4 bits, exibir, no display 7 segmentos, valores em hexadecimal, como na figura a seguir:
